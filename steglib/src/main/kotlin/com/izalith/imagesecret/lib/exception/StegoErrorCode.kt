...
enum class StegoErrorCode(val description: String) {
    ERROR_INVALID_IMAGE("Invalid image file"),
    ERROR_NOT_SUPPORTED_IMAGE_FORMAT("Not supported image format"),
    ERROR_PAYLOAD_READ("Payload extracting error"),
    ERROR_NOT_ENOUGH_SPACE_FOR_PAYLOAD("Not enough space for payload in the image")
}
